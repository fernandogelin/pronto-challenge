!function(){
	var bP={};
	var b=60, bb=500, height=450, buffMargin=1, minHeight=14;
	var c1=[-150, 80], c2=[-50, 100], c3=[-10, 220]; //Column positions of labels.
	var colors = ["rgb(31, 120, 180)", "rgb(31, 120, 180)", "rgb(178, 223, 138)", "rgb(51, 160, 44)", "rgb(251, 154, 153)", "rgb(227, 26, 28)", "rgb(253, 191, 111)", "rgb(255, 127, 0)", "rgb(202, 178, 214)", "rgb(106, 61, 154)", "rgb(255, 255, 153)", "rgb(177, 89, 40)"];
	...
	function drawEdges(data, id){
		...
		d3.select("#"+id).select(".edges").selectAll(".edge")
			...
			.attr("points", edgePolygon).style("fill","rgb(31, 120, 180)")
	...
	function drawHeader(header, id){
		...
		[0,1].forEach(function(d){
			...
			h.append("text").text(header[d]).attr("x", (c1[d]))
				.attr("y", -5).style("font-family","Bitter").style("font-size","20px");
